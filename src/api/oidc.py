...
from ..schemas import OIDCAuthRequest, OIDCCallbackRequest, TokenResponse, AccountLinkRequest
from ..auth.dependencies import get_current_user
from ..utils.error_handler import handle_auth_error, handle_validation_error, handle_generic_error
        ...
        try:
            ...
            if oidc_row:
                ...
                await conn.execute(
                    ...
                    email, name, avatar_url, oidc_row['id']
                )
                
                # Generate JWT token
                token_response = jwt_handler.create_token_response(user_row['id'], user_row['username'])
                ...
                if existing_user_row:
                    ...
                    await conn.execute(
                        ...
                        existing_user_row['id'], provider, provider_user_id, email, name, avatar_url
                    )
                    
                    # Generate JWT token
                    token_response = jwt_handler.create_token_response(existing_user_row['id'], existing_user_row['username'])
                    ...
                    user_id = await conn.fetchval(
                        ...
                        username, email, name, True, False, True
                    )
                    ...
                    # Generate JWT token
                    token_response = jwt_handler.create_token_response(user_id, username)
