...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: ASGIApp, redis_client: Optional[redis.Redis] = None):
        ...
        self.memory_store: Dict[str, Dict] = {}  # Fallback for when Redis is unavailable
    ...
    async def _is_rate_limited(self, client_ip: str) -> bool:
        ...
        if self.redis_client:
            try:
                return await self._redis_rate_limit(client_ip, current_time, window_start)
            except Exception:
    ...
    async def _redis_rate_limit(self, client_ip: str, current_time: int, window_start: int) -> bool:
    ...
    def _memory_rate_limit(self, client_ip: str, current_time: int, window_start: int) -> bool:
