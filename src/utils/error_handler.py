...
class SecureErrorHandler:
    ...
    def log_and_raise_validation_error(
        error: Exception, field: str = None, context: Dict[str, Any] = None
    ) -> None:
    ...
    def log_and_raise_not_found(
        error: Exception, resource: str = "resource", context: Dict[str, Any] = None
    ) -> None:
...
def handle_permission_error(
    error: Exception, action: str = "perform this action", **context
):
...
def handle_generic_error(
    error: Exception, message: str = "An error occurred", **context
):
