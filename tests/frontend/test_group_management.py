...
class TestGroupManagement:
    ...
    def test_create_group_with_all_fields(self, authenticated_page: Page, base_url: str):
        """
    ...
    def test_edit_group_multiple_times_all_fields(self, authenticated_page: Page, base_url: str):
        ...
        for iteration in range(3):
            ...
            desc_input = page.locator("#group-description, textarea[name='description']").first
    ...
    def test_create_multiple_groups_sequentially(self, authenticated_page: Page, base_url: str):
        ...
        for i in range(3):
            ...
            group_name = f"Sequential Group {i + 1} - {int(page.evaluate('Date.now()'))}"
    ...
    def test_group_modal_cancel_button(self, authenticated_page: Page, base_url: str):
        ...
        # Click cancel
        cancel_btn = page.locator("#cancel-create-group, button:has-text('Cancel')").first
    ...
    def test_delete_group(self, authenticated_page: Page, base_url: str):
        ...
        group_card = page.locator(f".group-card:has-text('{group_name}'), .group-item:has-text('{group_name}')").first
        delete_btn = group_card.locator("button:has-text('Delete'), .delete-btn, [title*='Delete']").first
        ...
        page.wait_for_timeout(500)
        confirm_btn = page.locator("button:has-text('Delete'), button:has-text('Confirm')").first
...
class TestGroupMemberManagement:
    ...
    def test_add_member_to_group(self, authenticated_page: Page, base_url: str):
        ...
        add_member_btn = page.locator("button:has-text('Add Member'), #add-member-btn").first
        ...
        if add_member_btn.count() > 0 and add_member_btn.is_visible():
            ...
            member_input = page.locator("#member-email, #member-username, input[placeholder*='email'], input[placeholder*='username']").first
            if member_input.count() > 0:
                member_input.fill("test@example.com")
                
                # Submit
                submit_btn = page.locator("button:has-text('Add'), button[type='submit']").first
                submit_btn.click()
                page.wait_for_timeout(1000)
    ...
    def test_group_member_list(self, authenticated_page: Page, base_url: str):
        ...
        members_section = page.locator(".members-list, #members-section, h3:has-text('Members')")
